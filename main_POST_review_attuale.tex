...
\newcommand{\DOLCEQualeDirectTer}[2]{\triRel{{ql}}{#1}{#2}{#3}}
...
Again, it is difficult to express functions- and performance-related requirements in form \refex{SCD} if one lacks an appropriate reference ontology. 
