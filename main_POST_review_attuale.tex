...
\bflist
  ...
  \item Note that such individuals must necessarily be systemic functions due to \refdf{def:main-function-of}.
\eflist
...
Finally, in Figure \ref{fig:model} we give a schema that shows the main relations and concepts in our ontology.
