...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{DOLCE-taxav2-nocolor.JPG}
...
\eflist 
For example, the role of `husband' is instantiation-founded on the concept of `marriage', since every time a person is a husband there is an individual marriage between that person and another person, which the `husband' role existentially depends on: there cannot be a husband if there is no marriage.\marginpar{\color{red}{Questo esempio va ampliato per esemplificare la formula d5 in modo sistematico.[FC:OK]}}
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{onto-func-taxav2-nocolor.JPG}
